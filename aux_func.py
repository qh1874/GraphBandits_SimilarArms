...
def generate_data(arm_type,K,seed):
    ...
    if arm_type==0: #Gaussian
        ...
        # reward_mat[0:9000,0]=np.random.uniform(0,0.5,9000)
        # reward_mat[9000:K,0]=np.random.uniform(0.7,0.9,K-9000)
...
@jit(nopython=True)
def get_reward_distribution_native(arm_type,T,K,p,seed):
